...
export const legalSections: LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Il utilise uniquement le `sessionStorage` du navigateur, pour deux réglages techniques (`perf`, `simulator`), effacés à la fermeture de l'onglet — exemptés de consentement (art. 82 de la loi Informatique et Libertés).",
