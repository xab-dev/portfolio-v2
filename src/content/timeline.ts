...
// Ordre chronologique par date de début (patch 2026-09-15 23:00) : source de
// vérité pour l'ordre, voir aussi le test "est dans l'ordre chronologique".
export const timeline: Milestone[] = [
  {
    id: "hatd",
    period: "01/08 – 07/09/2026",
  ...
  {
    id: "regie-maison",
    period: "28/08 – 01/09/2026",
    title: "Régie Maison",
    summary: "Premier projet livré : piloter TV Sony Bravia et Google Home depuis une interface unique.",
    kind: "projet",
    dateKnown: true,
  },
  {
  ...
  {
    id: "templates",
    period: "Depuis le 14/09/2026",
    title: "Bibliothèque de templates de spec",
    summary:
      "6 formats pour transformer une dictée brute en instruction exploitable par un agent de code. En phase de test.",
    kind: "projet",
    dateKnown: true,
  },
  {
    id: "portfolio-v2",
    period: "15 – 16/09/2026",
    title: "Portfolio v2",
    summary: "Portfolio/CV interactif piloté par specs, livré phase par phase — en ligne.",
    kind: "projet",
    dateKnown: true,
  },
  {
    id: "rpg-v2",
    period: "Depuis le 16/09/2026",
    title: "RPG-v2",
    summary: "Refonte complète du RPG en HTML5/Canvas, pilotée par specs — Grotte close, Maison en cours.",
    kind: "projet",
    dateKnown: true,
  },
];
