...
| ⏸ | DETTE-10 | Enrichissement des fiches projet | Rédigé (`src/content/projects.ts`, 6 fiches) à partir des sources réelles, sans métrique inventée. **[ARRÊT XAV]** : relecture d'exactitude requise avant clôture de la Phase 4 (critère §7.5). | Phase 4 |
