...
// public/images/projects/<id>/<id>-NN.webp (1600px max, ~200 Ko max).
// Les originaux vivent hors de public/ (jamais copiés dans le build) et hors
// du repo (voir .gitignore, DETTE-14).
...
async function encodeUnderBudget(pipeline) {
  ...
  for (const quality of QUALITY_STEPS) {
    ...
    if (lastBuffer.byteLength <= MAX_BYTES) {
