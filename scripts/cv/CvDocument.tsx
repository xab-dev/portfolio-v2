...
function buildStyles(fonts: CvFontSet) {
  return StyleSheet.create({
    ...
    paragraph: { fontSize: 9, color: COLOR_TEXT, marginBottom: mm(0.8) },
    muted: { color: COLOR_MUTED },
    project: { marginBottom: mm(1.5) },
    ...
    milestone: { flexDirection: "row", gap: mm(2), marginBottom: mm(0.8) },
    milestonePeriod: {
      fontFamily: fonts.bodyBold.fontFamily,
      fontWeight: fonts.bodyBold.fontWeight,
      fontSize: 7.5,
    ...
    contactLine: { fontSize: 8.5, marginBottom: mm(0.8), color: COLOR_ACCENT },
    skillFamily: { marginBottom: mm(1.2) },
    skillFamilyTitle: { fontSize: 7.5, fontFamily: fonts.bodyMedium.fontFamily, fontWeight: fonts.bodyMedium.fontWeight, color: COLOR_TEXT, marginBottom: mm(0.6) },
    skillLine: { fontSize: 7.8, color: COLOR_TEXT, marginBottom: mm(0.5) },
    languageLine: { fontSize: 8, color: COLOR_TEXT, marginBottom: mm(0.5) },
    footer: {
      position: "absolute",
      bottom: mm(4),
      left: mm(12),
