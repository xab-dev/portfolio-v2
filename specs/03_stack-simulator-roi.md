...
valeurIndicativeAn   = heuresGagneesAn × tauxHoraire (curseur, défaut 35 €/h — validé, DETTE-08)

Note : le curseur représente le **coût horaire interne du client** (ce que lui coûte une heure passée sur la tâche), pas le tarif de Xav. Le tarif de Xav (25-50 €/h selon intervention) est affiché en Phase 6 (Contact), pas ici — ne pas mélanger les deux.
```
